...
})(window,document,'script','dataLayer','GTM-PVVLHT8');</script>
      ...
      <div class="container" id="form-container-header">
        ...
        <div class="col-sm-6" id="main-header">
          <div class="" id="headerText">
            <h1 id="product-header">Thank you for your interest</h1>
        ...
        <div class="row">
          <div class="form-box">
            <div class="form-bottom">
              <p>At this time, you are not the right fit for any of our existing lenders. Please take advantage of one of the offers below.</p>
