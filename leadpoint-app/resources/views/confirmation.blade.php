...
<body id="blue-skies">
  <div id="header-section">
    <nav class="navbar navbar-inverse navbar-no-bg" role="navigation" id="nav-bg-content" style="margin-bottom: 0px;">
    ...
    <div class="row" style="padding-bottom: 20px;">
      <div class="col-md-12">
        <h3> What's next? Lenders from our network will be contacting you to discuss your options.</h3>
      </div>
    </div>
  </div>
